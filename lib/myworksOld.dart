...
class _MyWorksState extends State<MyWorks> {
        ...
        onSelected: (selectedItem) async {
          switch (selectedItem) {
            case "assign":
              {
                _assign(
                    myWorks[index].branchName,
                    myWorks[index].branchID,
                    myWorks[index].handlers,
  ...
  void _assign(
      String branchName, String branchID, List handlerList, String id) async {
    String handlersOld = "";
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              Flexible(
                                child: Text("Assign selected links to branch",
                                    style: TextStyle(
                          ...
                          Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                InkWell(
                                  onTap: () {
                                    _selectHandler(branchName, handlerList, id);
                                  },
                                  child: Container(
  ...
  void _selectHandler(String branchName, List handlerList, String id) {
    String handler = "";
    Navigator.of(context).pop();
    allHandler.clear();
                      ...
                      children: <Widget>[
                        ...
                        InkWell(
                          ...
                          onTap: () {
                            ...
                            _assign(branchName, branchID, handlerList, id);
                          },
                        ),
                      ],
                    ),
